		...
		<view :class="{dpn: isShowSearch}">
			...
			<view class="page-content">
				<mescroll-uni ref="mescroll" :fixed="false" :down="downOption" :up="upOption" @down="downCallback"
					@up="upCallback">
					<view class="banner">
						<swiper :indicator-dots="true" indicator-color="rgba(255,255,255,.5)" :autoplay="true"
							indicator-active-color="#ff372b" :duration="1000" :circular="true" class="swiper">
					...
					<view class="video-list song-list">
						...
						<view class="video-item" v-for="(item, index) in hotList" :key="index">

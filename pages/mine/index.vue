<template>
	<view>
		...
		<uni-nav-bar fixed :status-bar="true" title="我的音乐" @clickLeft="goCloud" @clickRight="goCloud">
			<block slot="left">
				<image src="/static/image/mine/l.png" class="top-img left"></image>
			</block>
			<!-- #ifdef APP-PLUS -->
			<block slot="left">
				<image src="/static/image/mine/l.png" class="top-img left"></image>
		...
		<scroll-view scroll-y="true"  class="page-content">
			<!-- #endif -->
			<scroll-view scroll-y="true" class="nav-list scroll-view" scroll-x :show-scrollbar="false">
...
import { apiGetRecommendSongs } from '@/apis/index1.js';
